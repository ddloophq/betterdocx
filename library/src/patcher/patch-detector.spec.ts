...
import { listPlaceholders, patchDetector } from "./patch-detector";
...
describe("patch-detector", () => {
    it("exposes patchDetector as a deprecated alias of listPlaceholders", () => {
        expect(patchDetector).toBe(listPlaceholders);
    });
