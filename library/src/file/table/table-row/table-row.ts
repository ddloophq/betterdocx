...
export class TableRow extends XmlComponent {
    ...
    /**
     * Creates a structurally independent row while retaining the supplied cells.
     * Table uses this before inserting vertical-merge continuation cells so a
     * caller-owned row can safely be reused in more than one table.
     */
    public clone(): TableRow {
        return new TableRow({ ...this.options, children: this.cells });
    }
