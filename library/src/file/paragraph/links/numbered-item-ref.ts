...
export class NumberedItemReference extends SimpleField {
    public constructor(bookmarkId: string, options?: INumberedItemReferenceOptions);
    /** @deprecated Pass `cachedValue` inside the options object instead. */
    public constructor(
        bookmarkId: string,
        cachedValue?: string,
    ...
    public constructor(
        bookmarkId: string,
        cachedValueOrOptions?: string | INumberedItemReferenceOptions,
        legacyOptions: INumberedItemReferenceOptions = {},
    ) {
        const options =
            typeof cachedValueOrOptions === "object"
                ? cachedValueOrOptions
                : { ...legacyOptions, cachedValue: cachedValueOrOptions };
