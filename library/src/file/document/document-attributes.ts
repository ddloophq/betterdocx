...
// Ordered namespace-abbreviation lists shared by the document-part roots.
// The order is preserved in the emitted xmlns declarations.
export const CORE_ATTRIBUTE_NAMESPACES: readonly DocumentAttributeNamespace[] = [
    "wpc",
    "mc",
    "o",
    "r",
...
const CHART_EX_ATTRIBUTE_NAMESPACES: readonly DocumentAttributeNamespace[] = [
    "cx",
    "cx1",
    "cx2",
    "cx3",
...
export const HEADER_FOOTER_ATTRIBUTE_NAMESPACES: readonly DocumentAttributeNamespace[] = [
    ...CORE_ATTRIBUTE_NAMESPACES,
    ...CHART_EX_ATTRIBUTE_NAMESPACES,
    "w16cid",
    "w16se",
];

export const DOCUMENT_ROOT_ATTRIBUTE_NAMESPACES: readonly DocumentAttributeNamespace[] = [
    ...CORE_ATTRIBUTE_NAMESPACES,
    ...CHART_EX_ATTRIBUTE_NAMESPACES,
    "aink",
    "am3d",
...
export const STYLES_ATTRIBUTE_NAMESPACES: readonly DocumentAttributeNamespace[] = [
    "mc",
    "r",
    "w",
    "w14",
