...
describe("values", () => {
    describe("universalMeasureValue", () => {
        ...
        it("should throw on invalid values", () => {
            expect(() => universalMeasureValue("25.4.0mm" as UniversalMeasure)).to.throw();
            expect(() => universalMeasureValue("foo-mm" as UniversalMeasure)).to.throw();
        });
    });
    ...
    describe("percentageValue", () => {
        ...
        it("should throw on invalid values", () => {
            expect(() => percentageValue("10.0.0%" as Percentage)).to.throw();
            expect(() => percentageValue("foo%" as Percentage)).to.throw();
        });
    });
