...
```ts
import { patchDocument } from "better-docx";
...
```ts
import { patchDocument, TokenNotFoundError, PatchType, TextRun } from "better-docx";
...
```ts
import { patchDetector, patchDocument, PatchType, ImageRun } from "better-docx";
