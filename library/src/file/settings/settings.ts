...
export type IHyphenationOptions = {
    ...
    /** Specifies the width of the hyphenation zone in twips (twentieths of a point): the distance from the right margin within which a word's end must fall for it to be hyphenated. */
