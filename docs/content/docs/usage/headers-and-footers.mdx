...
> Headers and Footers requires an understanding of [Sections](sections).
...
## Tables in Headers and Footers

The `children` of a `Header` or `Footer` accept `Table` elements as well as `Paragraph` elements. This is useful for laying out header content in columns, for example a logo on the left and the document title on the right:
                        ...
                        new Table({
                            ...
                            rows: [
                                new TableRow({
                                    children: [
                                        new TableCell({
                                            children: [new Paragraph("My Company")],
                                        }),
                                        new TableCell({
                                            children: [new Paragraph("Annual Report")],
                                        }),
                                    ],
                                }),
                            ],
