...
SKIP_VALIDATE=(
  ...
  85  # template-document — w14:paraId/textId attributes not in schema (Word 2010+ extension)
  87  # template-document — w14:paraId/textId attributes not in schema (Word 2010+ extension)
  88  # template-document — w14:paraId/textId attributes not in schema (Word 2010+ extension)
  89  # template-document — w14:paraId/textId attributes not in schema (Word 2010+ extension)
  90  # check-boxes — w14:checkbox element not in schema (Word 2010+ extension)
  94  # textbox — w:pict (VML) element not expected in schema position
  96  # template-document — w14:paraId/textId attributes not in schema (Word 2010+ extension)
)
