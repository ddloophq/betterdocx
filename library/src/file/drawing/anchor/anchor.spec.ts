...
describe("Anchor", () => {
    ...
    describe("#constructor()", () => {
        ...
        it("should prefer wrap margins over floating margins for the wrap element", () => {
            anchor = createAnchor({
                floating: {
                    verticalPosition: {
                        offset: 0,
            ...
            const textWrap = newJson.root[6];
            assert.equal(textWrap.rootKey, "wp:wrapSquare");
            assert.include(textWrap.root[0].root, {
                distT: 10,
                distB: 20,
                distL: 30,
                distR: 40,
        ...
        it("should fall back to floating margins when wrap has none", () => {
            anchor = createAnchor({
                floating: {
                    verticalPosition: {
                        offset: 0,
