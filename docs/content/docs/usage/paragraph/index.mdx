...
```ts
import { Paragraph } from "better-docx";
...
| [tabStop](../tabs)     | `{ left?: ITabStopOptions; right?: ITabStopOptions; maxRight?: { leader: LeaderType; }; center?: ITabStopOptions }` | Optional   |                                                                                                                                                             |
| [bullet](../bullet-points)  | `{ level: number }`                                                                                                 | Optional   |                                                                                                                                                             |
| [numbering](../numbering)   | `{ num: ConcreteNumbering; level: number; custom?: boolean }`                                                       | Optional   |                                                                                                                                                             |
...
```ts
import { HeadingLevel, Paragraph } from "better-docx";
