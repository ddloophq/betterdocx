    ...
    return (
        <main className="flex flex-col items-center justify-center flex-1 px-6 py-16">
            <div className="max-w-3xl text-center space-y-8">
                ...
                {/* Title */}
                <h1 className="text-5xl sm:text-6xl font-bold tracking-tight">better docx</h1>

                {/* Description */}
                <p className="text-xl text-fd-muted-foreground max-w-2xl mx-auto leading-relaxed">
                    Easily generate and modify{" "}
                    <code className="px-1.5 py-0.5 rounded bg-fd-secondary font-mono text-lg">
                        .docx
                    </code>{" "}
                    files with JS/TS.
                    <br />
                ...
                <p className="text-fd-muted-foreground text-sm max-w-xl mx-auto">
                    ...
                    <strong className="text-fd-foreground">modern use cases</strong>,{" "}
