...
import { createRenderSession } from "../xml-components";
...
describe("Paragraph", () => {
    ...
    describe("#thematicBreak()", () => {
        ...
        it("should merge a thematic break and explicit borders into a single w:pBdr", () => {
            const paragraph = new Paragraph({
                thematicBreak: true,
                border: {
                    top: {
        ...
        it("it should add numbered properties", () => {
            ...
            expect(tree["w:p"][0]["w:pPr"][1]).to.deep.equal({
                "w:numPr": [
                    ...
                    { "w:numId": { _attr: { "w:val": "{default-bullet-numbering-0}" } } },
                ],
            });
        });
    });
        ...
        it("should set Internal Hyperlink", () => {
            ...
            const tree = new Formatter().format(paragraph, {
                session: createRenderSession({
                    relationships: {
                        resolveHyperlink: () => "rIdtest-unique-id",
