...
import { ImageRun, Paragraph, TextRun } from "@file/paragraph";
...
describe("Formatter", () => {
    ...
    describe("#format()", () => {
        ...
        it("uses an independent deterministic session for each standalone format", () => {
            ...
            expect(formatter.format(image)).toEqual(formatter.format(image));
        });
    });
});
